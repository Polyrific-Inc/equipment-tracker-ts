...
describe('PositionController', () => {
  ...
  describe('getLatest', () => {
    ...
    it('should reject if limit exceeds 1000', async () => {
  ...
  describe('getLive', () => {
    ...
    it('should filter by geographic bounds when provided', async () => {
      ...
      mockPositionRepository.findInArea.mockResolvedValue({
        data: [{ id: '1', equipmentId: 'equip-1', latitude: 40.5, longitude: -73.5 }],
      });
  ...
  describe('bulkCreate', () => {
    ...
    it('should process all positions and return success', async () => {
    ...
    it('should handle partial failures and return appropriate status', async () => {
      ...
      expect(mockResponse.json).toHaveBeenCalledWith({
        ...
        data: {
          ...
          errors: expect.arrayContaining([
            expect.stringContaining('Failed to create position for equipment'),
          ]),
        },
        timestamp: expect.any(Date),
      });
    ...
    it('should handle errors and pass to next middleware', async () => {
      ...
      mockRequest.body = {}; // Invalid body to trigger error
  ...
  describe('getNear', () => {
    ...
    it('should reject if radius exceeds maximum', async () => {
  ...
  describe('getByAccuracy', () => {
    ...
    it('should reject if min accuracy is out of range', async () => {
      mockRequest.query = { min: '1500' };
    ...
    it('should reject if max accuracy is out of range', async () => {
      mockRequest.query = { max: '-10' };
  ...
  describe('getStats', () => {
    ...
    it('should filter statistics by equipment ID when provided', async () => {
  ...
  describe('cleanup', () => {
    ...
    it('should reject if days is out of range', async () => {
      mockRequest.query.days = '400'; // Exceeds 365 limit
  ...
  describe('analyzePatterns', () => {
    ...
    it('should handle errors for individual equipment and continue processing', async () => {
      mockPositionRepository.findByEquipmentInTimeRange
        ...
        .mockRejectedValueOnce(new Error('Equipment not found'));
